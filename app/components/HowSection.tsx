...
export default function HeroSection() {
    return (
        ...
        <div className="w-full h-[805px] absolute flex items-center justify-center">
            <Image src='/noise.svg' alt='Noise Background' className=' z-10' />
        </div>
            <div className="w-[1440px] h-[805px] relative flex justify-center bg-[#1E1E1E]">
                ...
                <Image alt="arrow3" className="w-[70px] h-[80px] left-[1021px] top-[60px] absolute" src='/arrow3.svg' />

                <div className="z-20">
                    <div className="w-[81px] h-[81px] left-[321px] top-[358px] absolute bg-amber-500 rounded-full" />
                    <Image alt="how1"className="w-[50px] h-[50px] left-[337px] top-[374px] absolute" src="/how1.svg" />

                    <div className="w-[81px] h-[81px] left-[679px] top-[358px] absolute bg-amber-500 rounded-full" />
                    <Image alt="how2"className="w-[50px] h-[50px] left-[695px] top-[374px] absolute" src="/how2.svg" />

                    <div className="w-[81px] h-[81px] left-[1036px] top-[358px] absolute bg-amber-500 rounded-full" />
                    <Image alt="how3"className="w-[50px] h-[50px] left-[1053px] top-[374px] absolute" src="/how3.svg" />
                </div>
                ...
                <Image alt="arrow1" className="w-[127px] h-[34px] left-[470px] top-[375px] absolute" src='/arrow1.svg' />
                <Image alt="arrow2"className="w-[127px] h-[34px] left-[840px] top-[375px] absolute" src='/arrow2.svg' />
            </div>
        </div>
    );
}