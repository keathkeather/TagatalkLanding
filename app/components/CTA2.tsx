        ...
        <div className="flex justify-center items-center mb-[28px] bg-slate-50 overflow-hidden">
            <div className="relative w-[1400px] h-[300px] bg-slate-50 overflow-hidden z-0">
                <div className="absolute  z-0 ">
                    <Image src="/purple-rectangle.svg" alt="Image 1" />
                    <div className="absolute top-[35px] left-[97px] text-white m-0 p-0">
                    <div className="flex items-center mb-2">
                        <Image src="/logo-v1.svg" alt="Image 1" className="mr-2" />
                    ...
                    <Image src="/join-discord.svg" alt="CTA1 Button" className="cursor-pointer h-[45px] w-[263px] m-0"  />
                </div>
                </div>
                <div className="absolute left-[642px] z-0">
                    <Image src="/orange-rectangle.png" alt="Image 2" />
